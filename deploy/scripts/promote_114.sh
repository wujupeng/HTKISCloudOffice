...
echo '=== Step 3: Update pg_hba.conf to allow 192.168.2.3 ==='
docker exec erp-guac-postgres bash -c "echo 'host replication replicator 192.168.2.3/32 md5' >> /var/lib/postgresql/data/pg_hba.conf"
